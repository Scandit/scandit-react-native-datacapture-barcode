...
class ScanditDataCaptureBarcodeFind: RCTEventEmitter {
    ...
    lazy var viewManager: BarcodeFindViewManager = {
        guard let manager = bridge.module(for: BarcodeFindViewManager.self) as? BarcodeFindViewManager else {
            fatalError("BarcodeFindViewManager not registered in bridge")
        }
        return manager
    }()
    ...
    func setBarcodeFindModeEnabledState(
        data: [String: Any],
    ...
    func registerBarcodeFindListener(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func unregisterBarcodeFindListener(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func registerBarcodeFindViewListener(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func unregisterBarcodeFindViewListener(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func barcodeFindViewStopSearching(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func barcodeFindViewStartSearching(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func barcodeFindViewPauseSearching(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func submitBarcodeFindTransformerResult(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
    ...
    func updateBarcodeFindFeedback(
        data: [String: Any],
        resolve: @escaping RCTPromiseResolveBlock,
        reject: @escaping RCTPromiseRejectBlock
    ) {
