...
class RCTBarcodeSelectionAimedBrushProvider (
    eventEmitter: DeviceEventManagerModule.RCTDeviceEventEmitter
) : BarcodeSelectionBrushProvider {

    companion object {
        private const val BRUSH_FOR_AIMED_BARCODE_EVENT_NAME =
    ...
    private val brushForBarcode =
        EventWithResult<Brush?>(BRUSH_FOR_AIMED_BARCODE_EVENT_NAME, eventEmitter)
