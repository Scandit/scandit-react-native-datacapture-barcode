...
/**
 * Base class for SparkScanView management.
 * Shared logic used by both legacy (Paper) and new (Fabric) architecture implementations.
 */
abstract class SparkScanViewManagerBase(
    ...
    protected val sparkScanModule: SparkScanModule
        get() {
            return serviceLocator.resolve(SparkScanModule::class.java.simpleName) as?
                SparkScanModule?
                ?: throw ModuleNotStartedError(SparkScanViewManagerBase::class.java.simpleName)
        }
}
